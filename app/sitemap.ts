...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const webinarEntries = getPublicWebinars().map((webinar) => ({ url: `${baseUrl}/webinars/${webinar.slug}`, lastModified: new Date(webinar.startsAt), changeFrequency: "weekly" as const, priority: 0.8 }));
