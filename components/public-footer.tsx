...
export async function PublicFooter() {
  ...
  const fallbackFooterItems: NavigationMenuItemView[] = [
    ["Sessions", "/webinars"], ["Shop", "/products"], ["Privacy Policy", "/privacy-policy"], ["Terms & Conditions", "/terms-and-conditions"], ["Refund policy", "/refund-policy"], ["Return policy", "/return-policy"], ["Shipping policy", "/shipping-policy"], ["Admin sign in", "/login"],
